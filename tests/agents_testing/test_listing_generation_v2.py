...
def test_generate_product_description():
    ...
    product_category="K-Beauty Skin Care"
    product_details = """
                    1- Major Ingredients:
                    Water,Hippophae Rhamnoides Water,Butylene Glycol,Propanediol,Glycerin,Niacinamide,1,2-Hexanediol,Isopentyldiol,Trehalose,Arginine,Carbomer,
                    Allantoin,Dipotassium Glycyrrhizate,Panthenol,Polyglyceryl-10 Laurate,Xanthan Gum,Ethylhexylglycerin,Adenosine,Ascorbyl Glucoside,3-O-Ethyl Ascorbic Acid,Sodium Ascorbyl Phosphate,
                    Disodium EDTA,Glyceryl Acrylate/Acrylic Acid Copolymer,Melia Azadirachta Flower Extract,Ocimum Sanctum Leaf Extract, 
                    Melia Azadirachta Leaf Extract,Citrus Limon (Lemon) Peel Oil,Curcuma Longa (Turmeric) Root Extract,Corallina Officinalis Extract,Glutathione,
                    Ascorbic Acid,Coco-Caprylate/Caprate,Hydrogenated Lecithin,Pentylene Glycol,Polyglyceryl-10 Oleate,Sodium Surfactin,Hydroxypropyl Cyclodextrin,Collagen,
                    Dipeptide-15,Tannic Acid,Polysorbate 20,Tripeptide-1,Anemarrhena Asphodeloides Root Extract,Cysteine,Thioctic Acid,Hexapeptide-9,Palmitoyl Pentapeptide-4,
                    Palmitoyl Tripeptide-5,Palmitoyl Tetrapeptide-7,Sodium Acetyl sh-Oligopeptide-195 SP Lysine N6-(Succinimidopropionyl Thioethyl Dipalmitoyl Glycerophosphate),
                    Sodium Phenylbutyroyl Histidinyl 4-t-Butyl D-Phenylalanyl Arginyl Lysine N6-(Succinimidopropionyl Thioethyl Dipalmitoyl Glycerophosphate),Limonene.
    ...
    """
    product_description = agent.generate_product_description(product_id, 
                                                             product_name, 
                                                             product_category, 
                                                             product_details)
...
if __name__ == "__main__":
    ...
    product_description = test_generate_product_description()
    print(f"Generated product description: {product_description}")